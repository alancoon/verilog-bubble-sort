...
#endif
static const char *ng0 = "//vlabfs.vlab.usc.edu/home$/monteran/Documents/finalproject/sort_tb.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
